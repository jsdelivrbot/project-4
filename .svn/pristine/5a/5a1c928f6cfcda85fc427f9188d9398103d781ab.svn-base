    ...
    '</div>');
        ...
        function dateCompareValidator(input) {
            if (input.filter("[name=end], [name=start]").length) {
                ...
                // [Change: check start or end is null]
                if (dates.start == null || dates.end == null) {
                    return true;
                }

                // [Change: set start to 01:00:00.000, set end to 23:00:00.000]
                dates.start.setHours(1);
        ...
        var GanttTask = kendo.data.Model.define({
            ...
            _offset: function (value) {
                ...
                for (var i = 0; i < field.length; i++) {
                    if (this.get(field[i])) { // [Change -- null check]
        ...
        var GanttDataSource = DataSource.extend({
            ...
            insert: function (index, task) {
                ...
                //[Change -- Delete, don't set order id]
                ...
                var modelChangeHandler = function (e) {
                    ...
                    switch (field) {
                        case "start":
                            ...
                            //[Change -- stop call this function]
            ...
            _resolveSummaryStart: function (summary) {
                // [Change -- Don't need this function]
                return;
        ...
        "columnResize"
            ...
            _toolbar: function () {
                ...
                toolbar = $("<div class='" + ganttStyles.toolbar.headerWrapper + "'>")
                    //.append(toggleButton) //[Change -- Remove toggle toolbar buttons]
                    //.append(views) //[Change -- Remove views toolbar buttons]
                    .append(actionsWrap);
            ...
            _dropDowns: function () {
                ...
                // [Change -- footer has been deleted]
                if (this.footer) {
            ...
            removeTask: function (uid) {
                ...
                //[Change -- go our delete function]
                if (typeof doDeleteTask == 'function') {
                    doDeleteTask(task);
                }
                else {
            ...
            removeDependency: function (uid) {
                ...
                //[Change -- go our delete function]
                if (typeof doDeleteDependency == 'function') {
                    doDeleteDependency(dependency);
                }
                else {
