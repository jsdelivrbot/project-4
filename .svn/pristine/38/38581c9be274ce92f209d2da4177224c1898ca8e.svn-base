      ...
      <div class="editPanel">
        <div class="edit-panel">
          <div class="details-panel-header">
            ...
            >
                <span v-if="flagForNewTitle == false">12</span>
                <span v-if="flagForNewTitle">w</span>
            </p>
            <i
            id="closePanel"
          ...
          <div class="details-panel-fields">
            ...
            <p class="paragraph" title="Click to edit"
               ...
               @click="switchInput"
            >
              <span v-if="flagForNewTitle == false"></span>
              <span v-if="flagForNewTitle"></span>
            </p>
            <!--edit comments-->
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      ...mapState(['newTaskId','taskTitle','flagForNewTitle','tempId','showEditPanel'])
    },
    ...
    methods: {
      ...
      toolBtnSave: function(e) {
         $(".boardcontent").eq(0).children().eq(1).children().eq(0).text($(e.target).val());
...
<style lang="scss" scoped="" type="text/css">
    @import './groupByDetailPanel.scss';
</style>