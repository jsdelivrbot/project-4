      ...
      <div class="tool">
        ...
        <div class="tool-right right">
          ...
          <div class="set left">
            ...
            <Poptip placement="bottom-end" width="240">
                <span class="tj set-common left" :title="userName">{{userName | assignedName}}</span>
                <div class="api" slot="content">
                  <div class="userAvatar">
                      <div class="avatarImg">{{userName | assignedName}}</div>
                      <div class="fullName">
                        {{userName}}
                      </div>
                      <div class="userCount">
                  ...
                  <div class="uploadImg">
                    <Upload
                        ...
                        <Button type="info" icon="ios-cloud-upload-outline">Upgrade to Pro</Button>
                    </Upload>
                  </div>
                </div>
            </Poptip>
      ...
      changeMenu(item) {
        ...
        switch( spaceName ) {
          case 'Home':
            ...
            _this.saveUserPrefer(spaceName,'/homepage/home')
          ...
          case 'Administrator':
            ...
            _this.saveUserPrefer(spaceName,'/homepage/administrator')
            _this.changeTestRunList(false);
            _this.changeListIcon(true);
            _this.changeTestIcon(false);
            break;
          case 'Members':
            ...
            _this.saveUserPrefer(spaceName,'/homepage/members')
            _this.changeTestRunList(false);
            _this.changeListIcon(true);
            _this.changeTestIcon(false);
            break;
          case 'Requirement':
            ...
            _this.saveUserPrefer(spaceName,'/homepage/requirement')
            _this.changeTestRunList(false);
            _this.changeListIcon(true);
            _this.changeTestIcon(false);
            break;
          case 'Management':
           _this.$router.push({path:'/homepage/manage/manageView',query:routerParams});
            _this.saveUserPrefer(spaceName,'/homepage/manage/manageView')
            _this.changeTestRunList(false);
            _this.changeListIcon(true);
            _this.changeTestIcon(false);
            break;
          case 'Test Run':
            ...
            _this.saveUserPrefer(spaceName,'/homepage/test/testrun')
          ...
          case 'Test Library':
            ...
            _this.saveUserPrefer(spaceName,'/homepage/test/testLibrary')
            _this.changeListIcon(false);
            _this.changeTestIcon(true);
            _this.changeTestRunList(false);     
            break;
          case 'Development':
            ...
            _this.saveUserPrefer(spaceName,'/homepage/development/boards')
            _this.changeTestRunList(false);
        ...
        this.axios.post(GET_HISTORY_INFO,queryParams).then(res=>{
            ...
            if(res.data.Success){
              ...
              if(preferences.length>0) {
                // 子节点访问记录
                if(preferences.length == 1 && preferences[0].PrefId == 3000040) {
                  pathObj.subprojectId=item.subprojectId,
                  pathObj.subprojectName=item.subprojectName,
                  pathObj.subprojectType=item.subprojectType,
                  pathObj.sprintState=item.sprintState
                }else {
