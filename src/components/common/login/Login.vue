    ...
    <div class="log-page" id="login">
        ...
        <div class="input-field">
            <div class="userName user-field">
                <Input v-model="userName" placeholder="user name" class="userName" style="width: 100%" @on-enter="userLogIn">
                    <Button slot="prepend" icon='person'></Button>
                </Input>
            </div>
            <div class="userPwd user-field">
                 <Input v-model="userPwd"  type="password" placeholder="user password" style="width: 100%" @on-enter="userLogIn">
...
<script>
   ...
   export default {
    ...
    methods: {
        userLogIn(){
            $('.userName input').blur().css("outline","none");
            $('.userPwd input').focus();
            var _this = this;
