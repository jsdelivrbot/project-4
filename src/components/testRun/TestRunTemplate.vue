...
export default {
  ...
  methods: {
    ...
    initGrid: function() {
      ...
      var STATUS_LIST = DevTestApi + 'TestTask/Field?token=' + user_token + '&ProjectId=' + _this.TEST.taskProjectId + '&FieldId=1107';
    ...
    initTemplateProgressBar: function(){
      ...
      $('.status-wrapper .action-card').each((index1,ele) =>{
        ...
        aryPercent.push(totalFail+totalPass == 0 ? 0 : parseInt(totalPass/(totalFail+totalPass)*100));
      })
      var index = 0;
